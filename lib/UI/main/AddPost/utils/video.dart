...
class VideoCompress extends StatefulWidget {
  final File videoFile;
  VideoCompress({required this.videoFile});
  @override
  _VideoCompressState createState() => _VideoCompressState();
}

class _VideoCompressState extends State<VideoCompress> {
  ...
  Future<void> _pickVideo(File pickedFile) async {
    ...
    if (response is OnSuccess) {
      ...
      context.read<AddPostProvider>().addImages(File(response.destinationPath));
