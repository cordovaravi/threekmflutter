          ...
          children: [
            ...
            ButtonBar(alignment: MainAxisAlignment.spaceEvenly, children: [
              TextButton.icon(
                  ...
                  label: Text(
                      AppLocalizations.of(context)?.translate("flip") ?? "")),
              TextButton.icon(
                  onPressed: () {
                    imageKey[imageselectedIndex].currentState!.rotate();
                  },
              ...
              TextButton.icon(
                  onPressed: () {
                    imageKey[imageselectedIndex].currentState!.reset();
                  },
...
//                             log(controller.videoPath.toString());
//                             // return Container(
//                             //     height: 300,
//                             //     width: MediaQuery.of(context).size.width,
//                             //     child: LocalPlayer(
