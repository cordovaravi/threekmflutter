                                                              ...
                                                              Navigator.push(
                                                                  ...
                                                                  MaterialPageRoute(
                                                                      builder: (context) =>
                                                                          NewsListPage(
                                                                            title:
                                                                                finalPost.banners![bannerIndex].imageswcta!.first.header.toString(),
                                                                            hasPostfromBanner:
                                                                                finalPost.banners![bannerIndex].imageswcta!.first.post,
                                                                          )));
                                                            } else if (finalPost
                                                                    .banners![
                                                                        bannerIndex]
