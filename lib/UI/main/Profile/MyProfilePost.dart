                                                              ...
                                                              : Column(
                                                                  children: [
                                                                    RichText(
                                                                        ...
                                                                        text: TextSpan(
                                                                            children: [
                                                                              TextSpan(text: 'We have received your documents. Our team will review it soon.', style: ThreeKmTextConstants.tk16PXPoppinsBlackMedium),
                                                                              WidgetSpan(
                                                                                  child: Image.asset(
...
class InstructionCard extends StatelessWidget {
  const InstructionCard({
    ...
    required this.As_a_citizen,
    required this.As_a_Business,
    required this.not_to_Share,
  }) : super(key: key);

  final List<String> questions;
  final List<String> subtitle;
  final List As_a_citizen;
  final List As_a_Business;
  final List not_to_Share;
                  ...
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          if (indexQ == 2 && not_to_Share.length == i) {
                            return Container(
...
class NewsCard extends StatefulWidget {
  ...
  NewsCard(
      {required this.selfProfileModel,
      required this.index,
