...
import 'package:threekm/Custom_library/Vimeo/src/player/raw_vimeo_player.dart';

import '../../flutter_vimeo_player.dart';
...
class _VimeoPlayerState extends State<VimeoPlayer>
  ...
  late Timer t;
  late Timer t2;
  late Animation _playPauseAnimation;
  ...
  _getTimestamp() {
    var position = _printDuration(
        new Duration(seconds: (controller.value.videoPosition ?? 0).round()));
    var duration = _printDuration(
        new Duration(seconds: (controller.value.videoDuration ?? 0).round()));
