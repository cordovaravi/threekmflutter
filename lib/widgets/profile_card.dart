...
//   final int index;
//   final bool? elevate;
//   const ProfileNews(this.data, {Key? key, this.elevate, required this.index})
//       : super(key: key);
//   @override
...
//                       ),
//                     ),
//                     child: ProfileDetailPopup(
//                       Get.find<AuthorProfileController>().posts[widget.index],
//                       index: index,
//                       onTapComment: () {
//                         // setState(() {
...
//               right: 0,
//               child: GetBuilder<AuthorProfileController>(
//                 builder: (_controller) => Transform.translate(
//                   offset: Offset(0, 22),
//                   child: Row(
//                     mainAxisAlignment: MainAxisAlignment.center,
//                     children: [
