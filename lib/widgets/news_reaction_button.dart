...
class NewsReactionButton extends StatefulWidget {
  @override
  createState() => NewsReactionButtonState();
}
...
class NewsReactionButtonState extends State<NewsReactionButton>
  ...
  String getImageIconBtn() {
    if (!isLongPress && isLiked) {
      return 'assets/fblike2x.png';
    } else if (!isDragging) {
      switch (whichIconUserChoose) {
        case 1:
          return 'assets/fblike2x.png';
        case 2:
          return 'assets/heart2x.png';
        case 3:
          return 'assets/trust2x.png';
        case 4:
          return 'assets/sad2x.png';
        case 5:
          return 'assets/lol2x.png';
        // case 6:
